    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_temp) {
            ...
            manager.beginTransaction().replace(
                    R.id.relativelayout_for_fragment,
                    aboutappFragment,
                    aboutappFragment.getTag()).commit();
